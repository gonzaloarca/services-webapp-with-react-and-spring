...
INSERT INTO post_zone(post_id, zone_id) VALUES (5,5);
...
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 4, 1, NOW(), 'Arreglo de fusibles facil');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 5, 1, NOW(), 'Arreglo de fusibles');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 3, 2, NOW(), 'Instalacion de tomacorrientes');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 4, 4, NOW(), 'Se me rompio una tuberia en la cocina');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 3, 4, NOW(), 'Se me rompieron las tuberias del banio');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 4, 4, NOW(), 'Se me rompio la caldera');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 4, 4, NOW(), 'Se me rompio la caldera denuevo');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 5, 4, NOW(), 'Se me rompio la caldera denuevo');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 2, 1, NOW(), 'Se me rompio una zapatilla');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 2, 1, NOW(), 'Arreglo de fusibles facil');
...
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 2, 1, NOW(), 'Instalacion de tomacorrientes');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 2, 1, NOW(), 'Se me rompio una tuberia en la cocina');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 2, 1, NOW(), 'Se me rompieron las tuberias del banio');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 2, 1, NOW(), 'Se me rompio la caldera');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 2, 1, NOW(), 'Se me rompio la caldera denuevo');
INSERT INTO contract(contract_id, client_id, package_id, contract_creation_date, contract_description) VALUES (DEFAULT, 2, 1, NOW(), 'Se me rompio la caldera denuevo');
...
INSERT INTO review(contract_id, review_rate, review_title, review_description) VALUES (2, 4, 'Muy bueno', 'Resolvio todo en cuestion de minutos');
INSERT INTO review(contract_id, review_rate, review_title, review_description) VALUES (4, 2, 'Medio pelo', 'Resolvio todo de forma ideal');
INSERT INTO review(contract_id, review_rate, review_title, review_description) VALUES (5, 4, 'Muy bueno', 'Resolvio todo en cuestion de minutos');
INSERT INTO review(contract_id, review_rate, review_title, review_description) VALUES (6, 2, 'Medio pelo', 'Resolvio todo de forma ideal');
INSERT INTO review(contract_id, review_rate, review_title, review_description) VALUES (7, 4, 'Muy bueno', 'Resolvio todo en cuestion de minutos');
INSERT INTO review(contract_id, review_rate, review_title, review_description) VALUES (8, 2, 'Medio pelo', 'Resolvio todo de forma ideal');
COMMIT;