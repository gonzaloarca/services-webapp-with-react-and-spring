...
<head>
    <title>
        <spring:message code="jobPost.packages.add.title" var="text"/>
    ...
    <div class="packages-frame">
        <div class="packages-container-wrapper">
            <div class="packages-container">
                ...
                <h4 class="font-weight-bold">Agregar paquete</h4>


                <c:url value="/job/${postId}/packages/add" var="postPath"/>
                <form:form modelAttribute="createPackageForm" method="post" action="${postPath}"
                           cssClass="mt-4">
