...
<head>
    <title>
        <spring:message code="account.settings.security.success.title" var="text"/>
...
<div class="content-container-transparent page">
    <div class="message">
        ...
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/login" role="button" type="submit">
            <spring:message code="account.settings.security.success.btn"/>
        </a>
    </div>
</div>
