...
public class RuntimeExceptionMapper implements ExceptionMapper<RuntimeException> {
    ...
    public Response toResponse(RuntimeException e) {
        return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity(new GenericEntity<HirenetRuntimeExceptionMessage>(new HirenetRuntimeExceptionMessage(e)) {
        }).build();
    }
